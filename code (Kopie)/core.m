function [res_tot, road, density_of_cars] = core(number_iterations)
    ...
    for i = 0:number_iterations
        [road, flow_delta_m, end_road_flow_count_tmp] = update_traffic(road, v_unit, p_toddle_slow, p_toddle_fast, v_max, v_min, v_slow_fast_differenciation, safety_distance_time, dec_fac, flow_delta_m);
        end_road_flow_count = end_road_flow_count + end_road_flow_count_tmp;
    end
    ...
    flow_rate = flow_rate';
    %res_tot = flow_rate;
    res_tot = end_road_flow_count / number_iterations;
